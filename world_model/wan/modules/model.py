...
class WanSelfAttention(nn.Module):
    ...
    def forward(self, x, seq_lens, grid_sizes, freqs):
        ...
        # Force dtype to match projection
...
# TODO: implement kv cache for I2V
# https://github.com/SkyworkAI/Matrix-Game/blob/6146d7ab2fb54f3e0700300f930113aeb64b6620/Matrix-Game-2/wan/modules/model.py#L228
# For matrix-game-2 it does have the text token, only the image token...
